...
//go:generate -command protoc protoc --plugin $GOPATH/bin/protoc-gen-gofast --gofast_out=plugins:$GOPATH/src -I=$GOPATH/pkg/mod -I=$GOPATH/pkg/mod/github.com/gogo/protobuf@v1.3.2/protobuf -I=$GOPATH/src
//go:generate protoc github.com/sensu/core/v3/entity_state.proto github.com/sensu/core/v3/entity_config.proto
